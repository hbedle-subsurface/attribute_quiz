...
Seismic attributes have personalities. Coherence is the one who notices everyone and everything. Aberrancy knew something was wrong before the fault even existed. Instantaneous phase is fascinating and cyclical and genuinely a liability in machine learning without the right transformation. Disorder is the only one who will tell you where things are genuinely falling apart.

This quiz was built as a lighthearted way to introduce attributes to anyone who finds the standard description - "a measure of lateral waveform similarity along structural dip" - a little dry. Which is most people.
...
Anyone who works with seismic data, teaches seismic interpretation, or has ever been in the same room as a time slice. The humor works whether you have thirty years of experience or thirty days. The science in the result cards is accurate either way.

Particularly useful for:
- Introducing students to attribute concepts without leading with equations
- Conference social events (print the results as name tags, you're welcome)
- Giving to a colleague who insists they don't need attributes
...
Every attribute in the quiz is part of the AASPI attribute library. The result descriptions are based on the actual physical behavior of each attribute and the workflow failure modes associated with misusing it. If you take the quiz and find yourself wanting to know more, the full attribute documentation lives in:

- **Seismic Attribute Selection Guide** - a structured tool that recommends attribute sets based on your geologic target and data conditioning: [launch tool](https://hbedle-subsurface.github.io/seismic-attribute-selector/)
- **Seismic ML Uncertainty Assessment** - a structured workflow check for anyone using unsupervised ML on seismic data: [launch tool](https://hbedle-subsurface.github.io/seismic_ml_assessment/)
